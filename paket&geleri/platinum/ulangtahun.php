...
// Query untuk mendapatkan data Paket Platinum dengan Dekor Lamaran 
$sql = "SELECT * FROM galeri WHERE jenis_paket='Paket Platinum' AND jenis_dekor='Dekor Ulang Tahun'"; 
$result = $db->query($sql);
?>  
    ...
    <div class="container mt-custom">         
        <div class="row g-3 justify-content-center">             
            ...
            if ($result && $result->num_rows > 0) {                 
                ...
                echo "<p class='text-center'>Tidak ada data paket platinum dengan dekor lamaran</p>";             
            }             
